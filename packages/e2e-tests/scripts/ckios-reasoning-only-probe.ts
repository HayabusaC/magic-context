...
for (const enabled of [false, true]) {
    ...
    try {
        ...
        mock.script([
            ...
            { content: [{ type: "thinking", thinking: thinkingText, signature: thinkingSignature }], stop_reason: "end_turn", usage: { input_tokens: 1000, output_tokens: 1 } },
        ]);
