...
| `historian_timeout_ms` | number (60000–) | `600000` | Timeout for each historian prompt call in both TypeScript and Rust transform modes, in milliseconds (default: 600000) |
