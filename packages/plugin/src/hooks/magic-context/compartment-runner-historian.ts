...
import { historianProducerReserve, producerInputTokenLimit, producerPromptFailureReason } from "./producer-window-guard";
                            ...
                            (request: import("../../shared/model-suggestion-retry").PromptArgs) => {
                                ...
                                const contextLimitTokens = selected
                                 ...
                                 if (contextLimitTokens !== undefined && producerInputTokenLimit(contextLimitTokens, reserve) === undefined && modelKey && !unknownProducerWindows.has(modelKey)) {
                                     ...
                                     shared.sessionLog(parentSessionId, `producer window inconsistent for ${modelKey}: window=${contextLimitTokens} reserve=${reserve}; sending unguarded`);
                                 }
