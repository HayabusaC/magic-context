    ...
    return [
        {
            ...
            // CURATE-ONLY now. Curate edits through ctx_memory and enumerates through
            // ctx_memory_list; it never reads code because a separate verify task
            ...
            allowedTools: ["ctx_memory", "ctx_memory_list"],
