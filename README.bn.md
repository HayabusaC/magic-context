...
*এটি একটি কমিউনিটি অনুবাদ। ইংরেজি [README.md](./README.md) সত্যের উৎস এবং এটি আরও হালনাগাদ হতে পারে।*

<h1 align="center">Magic Context</h1>

<p align="center">
  <strong>সীমাহীন প্রসঙ্গ। নিজে নিজে পরিচালিত স্মৃতি। একটি সেশন, সারাজীবনের জন্য।</strong><br>
...
<p align="center">
  <em>আপনি একজন ডেভেলপারকে একটি কাজের জন্য নিয়োগ করে কাজ শেষ হলেই বরখাস্ত করেন না।<br>আপনার এজেন্টের সঙ্গেও তা করা বন্ধ করুন।</em>
</p>

<p align="center">
  <a href="#magic-context-কী">Magic Context কী?</a> ·
  <a href="#দ্রুত-শুরু">দ্রুত শুরু</a> ·
  <a href="#cortexkit-এর-অংশ">CortexKit</a> ·
  <a href="#প্রসঙ্গ-ব্যবস্থাপনা">প্রসঙ্গ</a> ·
  <a href="#ধরা">ধরা</a> ·
  <a href="#সংহতি">সংহতি</a> ·
  <a href="#স্মরণ">স্মরণ</a> ·
...
ইন্টারঅ্যাকটিভ সেটআপ উইজার্ড চালান। এটি আপনার মডেল শনাক্ত করে, সবকিছু কনফিগার করে এবং সামঞ্জস্য সামলায়।
...
**ম্যানুয়াল সেটআপ** (OpenCode): `opencode.json`-এ plugin যোগ করুন ও compaction বন্ধ করুন, তারপর `<project>/.cortexkit/`-এ `magic-context.jsonc` রাখুন (অথবা user-wide defaults-এর জন্য `~/.config/cortexkit/`)। [configuration reference](./CONFIGURATION.md) দেখুন।
...
<details>
<summary><strong>অন্য context-management plugins-এর সঙ্গে সামঞ্জস্য</strong></summary>
...
| **[AFT](https://github.com/cortexkit/aft)** | Sensorimotor cortex | code structure উপলব্ধি করে এবং তাতে সুনির্দিষ্টভাবে কাজ করে। আপনার এজেন্টের জন্য যথাযথ IDE এবং OS। |
| **Alfonso** *(শীঘ্রই আসছে)* | Prefrontal cortex | নির্বাহী নিয়ন্ত্রণ। পরিকল্পনা করে, কাজ ভেঙে দেয়, এজেন্ট ও মডেল বেছে নেয়, এবং কখন জিজ্ঞেস, যাচাই ও commit করতে হবে সিদ্ধান্ত নেয়। |

Magic Context হলো **আপনার কখনও দরকার হবে এমন ৩টি plugin-এর ১টি।** এটি মনে রাখে; AFT দেখে ও কাজ করে; Alfonso সিদ্ধান্ত নেয়। তারা একটি CortexKit store শেয়ার করে, তাই স্মৃতি harnesses ও tools জুড়ে জমা হয়।

---

## ⚡ প্রসঙ্গ ব্যবস্থাপনা

*নিজে নিজে পরিচালিত সীমাহীন সেশন।* কাজ করতে করতে context window ভরে যায়, আর সাধারণ সমাধান compaction এজেন্টকে থামিয়ে সবকিছু আবার পড়ায়। Magic Context পটভূমিতে ধারাবাহিকভাবে এটি সামলায়, তাই সেশন চলতেই থাকে।
...
Settings থাকে `magic-context.jsonc`-এ। সবকিছুর sensible defaults আছে; project config user-wide settings-এর ওপর merge হয়। পূর্ণ reference, cache TTL tuning, per-model execute thresholds, historian ও dreamer model selection, embedding providers এবং memory settings-এর জন্য **[CONFIGURATION.md](./CONFIGURATION.md)** অথবা **[docs.cortexkit.io-এর configuration reference](https://docs.cortexkit.io/magic-context/reference/configuration/)** দেখুন।
...
**প্রয়োজনীয়তা:** [Bun](https://bun.sh) ≥ 1.0
